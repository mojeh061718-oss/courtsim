...
export default {
  ...
  aiPretrialMotions: {
    prosecution: [
      { id: 'p1', title: 'Motion in limine to exclude unproffered abuse allegations against George Anthony', argument: 'The defense should be barred from accusing George Anthony of sexual abuse or of staging the death scene unless it proffers actual admissible evidence. Opening statements are not a license to assassinate a witness\'s character with facts counsel never intends to prove.', background: "In reality and in this file, the defense theory accuses George Anthony of abuse and of staging an accidental drowning — but no admissible evidence has ever been proffered for either, and George denies both. For the motion: counsel may not promise a jury facts they will never prove; an opening is not immunity for character assassination. Against: the defense is entitled to its theory, the proffer can come through cross, and gagging it pre-trial guts the defense before it starts." },
      { id: 'p2', title: 'Motion to admit the corrected computer-search evidence', argument: 'The chloroform and "neck breaking" searches are admissible with the corrected single-visit count; the earlier software error goes to weight, not admissibility, and the State will front the correction.', background: "The family desktop shows a search for chloroform and related terms in March 2008. The State's first analysis claimed 84 visits; corrected forensics showed one visit, and Cindy Anthony has claimed she may have made some searches. For admission: the search happened, the correction goes to weight, and the State will front the error. Against: evidence whose headline number collapsed 84-to-1 is exactly the kind of unreliable forensic showpiece a jury cannot unhear." },
    ],
    defense: [
      { id: 'd1', title: 'Motion to exclude trunk-odor and air-chemistry evidence (Frye)', argument: 'Dr. Vass\'s "odor signature" air analysis is novel science with no peer-reviewed standards, no error rate, and no general acceptance. Florida is a Frye state; this is precisely the unvetted technique Frye exists to keep from a jury.', background: "Dr. Vass analyzed air and carpet from the trunk and claims a decomposition odor signature plus chloroform at unusual levels — a technique with no peer-reviewed standards, no known error rate, and no other courtroom acceptance. Florida follows Frye. For exclusion: novel science that no community has accepted cannot reach a jury. Against: the underlying chemistry (GC-MS) is utterly standard; what is novel is only the application, and that is cross-examination material." },
      { id: 'd2', title: 'Motion to exclude cadaver-dog alerts', argument: 'A dog\'s alert is an out-of-court assertion that cannot be cross-examined, resting on handler interpretation with documented false-alert rates. Its prejudice vastly outweighs its probative value.', background: "Two cadaver dogs alerted at the car trunk and, less cleanly, in the backyard. Handlers concede documented false alerts, and a dog cannot be cross-examined — the alert arrives only through the handler's interpretation. For exclusion: hearsay-by-animal with real prejudice. Against: trained-dog reliability is established in Florida law, both dogs hit the same trunk independently, and the alerts corroborate the human smell witnesses." },
      { id: 'd3', title: 'Motion to exclude "party photos" and tattoo evidence', argument: 'Photographs of the defendant dancing and a tattoo reading "Beautiful Life" are raw character assassination — grief presents in many ways, and Rule 403 does not permit the State to convict a mother for partying.', background: "During the 31 days Caylee was unreported, the defendant entered a nightclub contest, and afterward got a tattoo reading Bella Vita — beautiful life. The State calls this consciousness of guilt and absence of grief. For exclusion: grief has no required face; punishing a mother for coping is Rule 403 character assassination. Against: no innocent explanation fits a mother partying while claiming her child was kidnapped — it is conduct, not character." },
    ],
  },
  aliases: [
