...
export default {
  ...
  aiPretrialMotions: {
    prosecution: [
      { id: 'p1', title: 'Motion in limine to limit "overmedication" evidence absent causation', argument: 'The defense should not parade thirteen drug names before the jury without expert testimony that any of them can cause this conduct. Prescription counts without causation are sympathy dressed as science.', background: "Over months of treatment the defendant was prescribed roughly a dozen psychiatric medications — benzodiazepines, antidepressants, sleep aids — with repeated changes. The defense suggests overmedication (including akathisia) drove her condition. For the motion: without an expert saying THIS drug at THIS dose can cause THIS conduct, a pill list is sympathy dressed as science. Against: the treatment course is inseparable from the insanity defense; the jury cannot judge her mind while blind to what was being done to it." },
      { id: 'p2', title: 'Motion to admit the defendant\'s post-incident statements', argument: 'The defendant\'s brief statements upon her husband\'s return were spontaneous, not the product of interrogation, and are admissible as excited utterances and party admissions probative of awareness.', background: "When Patrick Clancy came home and in the first minutes afterward, the defendant made brief statements about what she had done. The State offers them as excited utterances and party admissions showing awareness. For admission: spontaneous, unprompted, no interrogation. Against: words from a woman mid-psychotic-collapse who had just gone out a window are not reliable evidence of a guilty mind — they are symptoms." },
    ],
    defense: [
      { id: 'd1', title: 'Motion to suppress hospital-bed statements to police', argument: 'Any statements taken while the defendant lay catastrophically injured, medicated, and in custody-like restraint, without valid Miranda waiver, must be suppressed as involuntary.', background: "Police obtained statements while the defendant lay in a hospital bed, catastrophically injured from her fall, heavily medicated, immobilized, and effectively in custody. For suppression: no valid Miranda waiver is possible in that state; the statements are involuntary. Against: she was not under arrest, the questions were brief and open, and voluntariness is a jury question — her lucidity on the recording speaks for itself." },
      { id: 'd2', title: 'Motion in limine to exclude gruesome scene and autopsy imagery', argument: 'Cause of death will not be contested. The only purpose of this imagery is to make deliberation impossible. A sanitized subset satisfies any legitimate need under the balancing test.', background: "The State holds scene and autopsy imagery of the three children; strangulation as cause of death will not be contested. For limitation: with cause conceded, the only function of the imagery is to make deliberation about her mental state impossible. Against: the deliberateness and duration of the act bears directly on whether she could form intent — the very thing the insanity defense disputes." },
      { id: 'd3', title: 'Motion to admit complete mental-health treatment history', argument: 'The entire treatment course — every switch, every screening, the December admission — is the res gestae of the insanity defense and must come in without piecemeal hearsay objections; it is offered for treatment fact, not truth of diagnosis.', background: "The full treatment record — every medication switch, every screening that did or did not flag psychosis, the December partial-hospitalization admission — is layered with hearsay. The defense wants it in whole as the res gestae of insanity. For admission: it is offered as treatment fact, not diagnosis-truth, and piecemeal objections would shred the story of her deterioration. Against: records are full of self-reported symptoms — self-serving hearsay the State cannot cross-examine." },
    ],
  },
  aliases: [
